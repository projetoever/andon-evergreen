  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">Gerencie arquivos por máquina e tipo de chamado.</p>
      </div>
...
function TechniciansTab() {
  ...
  return <div className="space-y-4"><div className="space-y-1"><h3 className="text-base font-bold">Manutentores</h3><p className="text-sm text-muted-foreground">Cadastre, edite e inative manutentores por área e turno.</p></div><div className="grid gap-4 md:grid-cols-[minmax(280px,360px)_1fr]">
