...
try { Assert-AndonAdmin; Import-AndonConfig | Out-Null; Invoke-AndonHealthCheck -Full; exit 0 } catch { Write-AndonHeader "ERRO"; Write-AndonFail "$($_.Exception.Message)"; exit 1 }
