...
function Show-AndonMenu {
    do {
        Clear-Host
        Write-AndonHeader "ANDON WEB INDUSTRIAL - INSTALADOR V10.6.1"
        Show-AndonStatus
        ...
        Write-Host "0  - Sair"
        Write-Host ""
        Write-Host "Internet necessaria: 1, 2 e 3. Demais opcoes operam localmente apos instalado." -ForegroundColor DarkYellow
        Write-Host ""
        ...
        switch ($option) {
            ...
            "5" { Invoke-AndonMenuScript "$Global:AndonInstallerPath\stop-andon.ps1" "Parar ANDON temporariamente" }
            ...
            "8" { Disable-AndonAutoStart; Read-Host "Pressione ENTER para voltar" }
            "9" { Enable-AndonAutoStart; Read-Host "Pressione ENTER para voltar" }
